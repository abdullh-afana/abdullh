...
<link rel="stylesheet" href="{{ asset('css/app_friend.css') }}">

@yield('styles')
</head>

<body class="@yield('body-class', 'page-admin-dashboard')">
    <div class="layout">
        ...
        <aside class="sidebar offcanvas offcanvas-start offcanvas-lg" tabindex="-1" id="adminSidebar">
            ...
            <div class="offcanvas-body">
                <div class="brand d-flex align-items-center gap-2">
                    <img src="{{ asset('img/logo.jpg') }}" alt="الشعار" style="width: 40px; height: 40px; object-fit: cover; border-radius: 8px;">
                ...
                <div class="mt-auto pt-4">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button class="logout border-0 bg-transparent w-100 text-start" type="submit" style="color: #dc3545;">
